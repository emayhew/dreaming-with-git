...
#mixturesWithFeatures <- read.csv("data/raw/processed/MixturesWithFeatures.csv")
...
nnetFit<-train(experimental_values ~ diff_mixture_size + overlap_percent + angle_dist, data = train_set,
             method = "nnet",
             trControl = fitControl,
             metric="RMSE")
#Look at performance in cross-validation
